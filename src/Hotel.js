        ...
        <>
            <div className='col'>
                ...
                <div className="row">
                    ...
                    <div>
                        <button className="button" disabled={adults === 30} onClick={handleAdultsAdd}>+</button>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div>
                        <button className="button" disabled={children === 30} onClick={handleChildrenAdd}>+</button>
                    </div>
                </div>
